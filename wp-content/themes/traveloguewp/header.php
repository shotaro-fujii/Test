...
<style type="text/css">
    ...
    .cd-primary-nav-trigger .cd-menu-icon{
        background-color: <?php echo esc_attr( $travelogue_redux_options['header_buttons_border']['border-color'] ); ?>
    }
    ...
    body .sound,
    button.trigger{
        color: <?php echo esc_attr( $travelogue_redux_options['header_buttons_border']['border-color'] ); ?>;
    }
    a:before{
        border-bottom: 2px solid <?php echo esc_attr( $travelogue_redux_options['url_links_color']['regular'] ); ?>;
    }
    <?php if ($travelogue_redux_options['travelogue_enable_loader']) { ?>
        .bg-img{
            background: url(<?php echo esc_attr( $travelogue_redux_options['travelogue_loading_animation']['url'] ); ?>) no-repeat center center <?php echo esc_attr($travelogue_redux_options['travelogue_loading_bg']); ?>;
        }
    <?php } ?>
    ...
    /* From CSS Editor */
    <?php echo esc_attr( $travelogue_redux_options['css-code'] ); ?>
...
<body <?php body_class($page_custom_class . ' ' . $travelogue_sidebar_effect . ' ' . $contact_class); ?>>
    <style type="text/css">
        <?php echo $travelogue_redux_options['css-code'] ?>
    </style>
