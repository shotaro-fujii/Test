            	...
            	<div class="inner">
                	<table class="wp-list-table widefat fixed bsf-sys-info">
                    	<tbody>
                            ...
                            <tr>
                            	<td>MYSQL Version</td><td><?php echo mysql_get_server_info(); ?></td>
                            </tr>
                            <tr>
                            ...
                            <tr class="<?php echo (!function_exists('curl_version')) ? 'bsf-alert' : ''; ?>">
                            	<td>cURL</td><td><?php echo (function_exists('curl_version')) ? 'Enabled' : 'Not Enabled'; ?></td>
                            </tr>
                            <tr class="alternate">
                            ...
                            <tr class="alternate">
                            	<th colspan="2"><?php echo __('Installed Plugins','bsf'); ?></th>
                            </tr>
                            <tr>
                            	<td colspan="2" class="bsf-table-active-plugin">
                                	<table>
                                	<?php 
										$plugins = get_plugins();
										asort($plugins);
