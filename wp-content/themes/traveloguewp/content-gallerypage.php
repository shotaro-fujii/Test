...
#$number = $travelogue_redux_options['travelogue_gallery_items_per_page'];
wp_reset_postdata();
...
<div id="filter-nav">
	<nav id="filter-main-nav">
		<ul>
			<li><a href="#" data-filter="*"><?php echo __('All', 'travelogue'); ?></a></li>
			<?php 
			...
			?>
			<li class="filter-title"><?php echo __('Filters', 'travelogue'); ?></li>
		</ul>
	</nav>
