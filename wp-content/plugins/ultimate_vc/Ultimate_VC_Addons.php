...
if(!defined('ULTIMATE_VERSION')){
	define('ULTIMATE_VERSION', '3.12.0');
}
...
if(is_multisite())
	add_action('network_admin_menu', 'register_bsf_products_registration_page',9999);
else
	add_action('admin_menu', 'register_bsf_products_registration_page',9999);
...
if(version_compare(ULTIMATE_VERSION, '3.11.1', '>') && version_compare(ULTIMATE_VERSION, '3.12.1', '<')) {
	...
	$current_status = $activation_check['status'];
