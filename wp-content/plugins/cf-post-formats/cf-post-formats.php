...
//Create Post Formats
add_action( 'init', 'mes_testimonials' );
function mes_testimonials() {
	register_post_type( 'testimonials',
		array(
			'labels' => array(
				'name' => __( 'Testimonials', 'mestowabo' ),
				'singular_name' => __( 'Testimonials', 'mestowabo' ),
				'new_item' => __( 'Add New testimonial', 'mestowabo' ),
				'add_new_item' => __( 'Add New testimonial', 'mestowabo' )
			),
			'public' => true,
			'has_archive' => false,
...
//Create Post Formats
add_action( 'init', 'mes_portfolio' );
function mes_portfolio() {
	register_post_type( 'portfolio',
		array(
			'labels' => array(
				'name' => __( 'Portfolio', 'mestowabo' ),
				'singular_name' => __( 'Portfolio', 'mestowabo' ),
				'new_item' => __( 'Add New portfolio', 'mestowabo' ),
				'add_new_item' => __( 'Add New portfolio', 'mestowabo' )
			),
			'public' => true,
			'has_archive' => false,
			'supports' => array( 'comments', 'editor', 'excerpt', 'thumbnail', 'title' ),
...
function mes_portfolio_taxonomies() {
...
add_action( 'init', 'mes_portfolio_taxonomies', 0 );
